            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              ...
              {profile?.is_published && profile?.username && (
                <a
                  ...
                  class="inline-flex items-center justify-center  gap-2 px-4 py-2 text-sm font-medium text-indigo-600 bg-indigo-50 rounded-lg hover:bg-indigo-100 active:bg-indigo-200 touch-manipulation"
                >
                  View Public Page →
                </a>
              )}
