...
> = {
  ...
  // Backward compatibility: map old 'twitter' key to 'x'
  twitter: {
    icon: (
      <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
      ...
      <div class={`min-h-screen ${styles.bg} py-12 px-4`}>
        <div class="max-w-md mx-auto">
          ...
          <div class={`${styles.card} rounded-2xl p-8 text-center mb-8`}>
            ...
            {profile.bio && (
              <p
                class={`${styles.text} opacity-80 text-sm leading-relaxed mb-4`}
              >
                {profile.bio}
              </p>
            )}
            ...
            {profile.social_links &&
              Object.keys(profile.social_links as Record<string, string>)
                  .length >
                0 &&
              (
